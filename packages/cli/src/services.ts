...
import {IMinifierService} from "./service/minify/i-minifier-service";
import {MinifierService} from "./service/minify/minifier-service";
...
DIContainer.registerSingleton<IMinifierService, MinifierService>();
...
DIContainer.registerSingleton<NormalizeFunction<IFoveaCliConfig>, NormalizeFunction<IFoveaCliConfig>>(() => foveaCliConfigNormalizeFunction);
