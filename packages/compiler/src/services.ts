...
import {CompilerHintParser} from "./compiler-hint/compiler-hint-parser/compiler-hint-parser";
import {ICompilerHintTokenizer} from "./compiler-hint/compiler-hint-tokenizer/i-compiler-hint-tokenizer";
import {CompilerHintTokenizer} from "./compiler-hint/compiler-hint-tokenizer/compiler-hint-tokenizer";
...
DIContainer.registerSingleton<ICompilerHintParser, CompilerHintParser>();
DIContainer.registerSingleton<ICompilerHintTokenizer, CompilerHintTokenizer>();
