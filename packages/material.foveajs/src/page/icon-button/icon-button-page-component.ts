...
import {IconComponent, IconButtonComponent, CheckboxComponent, ICON_SEND, ICON_ALARM, ICON_ALARM_FILL, ICON_BELL, ICON_BELL_FILL, ICON_HEART, ICON_HEART_FILL} from "@fovea/material";
...
IconComponent.addIcons(ICON_HEART, ICON_HEART_FILL, ICON_ALARM, ICON_ALARM_FILL, ICON_BELL, ICON_BELL_FILL, ICON_SEND);
...
@dependsOn(IconButtonComponent, CheckboxComponent, Highlight, ShowcaseComponent, ApiReferenceComponent)
