 ...
 */
export const VISIBILITY_OBSERVERS_FOR_HOST: WeakMultiMap<IFoveaHostConstructor|ICustomAttributeConstructor, Partial<IVisibilityObserver>> = new WeakMultiMap(); /*# END IF hasVisibilityObservers */