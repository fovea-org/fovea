 ...
 */
export const BOUND_VISIBILITY_OBSERVERS: WeakMultiMap<IFoveaHost|ICustomAttribute, IVisibilityObserverResult> = new WeakMultiMap(); /*# END IF hasVisibilityObservers */