...
import {ExpressionChain, FoveaHost, ICustomAttributeConstructor} from "@fovea/common";
 ...
 * @returns {IObserver}
 */
export function attachCustomAttribute (host: FoveaHost, element: Element, name: string, value?: ExpressionChain|IExpressionChainDict, templateVariables?: ITemplateVariables): IObserver&IDestroyable {
