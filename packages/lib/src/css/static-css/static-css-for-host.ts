 ...
 */
export const STATIC_CSS_FOR_HOST: WeakMultiMap<IFoveaHostConstructor|ICustomAttributeConstructor, () => HTMLTemplateElement[]|undefined> = new WeakMultiMap(); /*# END IF hasStaticCSS */