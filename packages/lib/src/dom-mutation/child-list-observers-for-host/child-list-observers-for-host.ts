 ...
 */
export const CHILD_LIST_OBSERVERS_FOR_HOST: WeakMultiMap<IFoveaHostConstructor|ICustomAttributeConstructor, Partial<IChildListObserver>> = new WeakMultiMap(); /*# END IF hasChildListObservers */