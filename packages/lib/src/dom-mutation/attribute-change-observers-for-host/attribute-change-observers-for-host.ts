 ...
 */
export const ATTRIBUTE_CHANGE_OBSERVERS_FOR_HOST: WeakMultiMap<IFoveaHostConstructor|ICustomAttributeConstructor, Partial<IAttributeChangeObserver>> = new WeakMultiMap(); /*# END IF hasAttributeChangeObservers */